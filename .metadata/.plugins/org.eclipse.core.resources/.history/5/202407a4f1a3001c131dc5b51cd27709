...
public class EntregaController {
	...
	public ResponseEntity<Entrega> buscar(@PathVariable Long entnregaId) {
		return entregaRepository.findById(entnregaId).map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
	}
}
